namespace GardenAI.Application.Weather.Contracts;

/// <summary>
/// Query options for the Open-Meteo forecast endpoint.
/// </summary>
public sealed record OpenMeteoForecastRequest
{
    ...
    /// <summary>Current weather variables to include.</summary>
    ...
    /// <summary>Optional temperature unit.</summary>
