...
using GardenAI.Application.Weather.Contracts;
using GardenAI.Integrations.OpenMeteo.Forecast.Exceptions;

namespace GardenAI.Integrations.OpenMeteo.Forecast.Clients;
